    ...
    <>
      <div className="bg-white p-6 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-b pb-6 border-gray-200 dark:border-gray-700">
          <fieldset className="border rounded-lg p-4 border-gray-300 dark:border-gray-600"><legend className="text-lg font-semibold text-gray-800 px-2 dark:text-gray-100">Font 1</legend><div className="grid grid-cols-1 gap-4"><div><label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Font URL</label><input type="text" value={font1Url} onChange={(e) => setFont1Url(e.target.value)} className="w-full p-3 border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" /></div><div><label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Font Family Name</label><input type="text" value={font1Family} onChange={(e) => setFont1Family(e.target.value)} className="w-full p-3 border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" /></div><div><label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Sample Text 1</label><input type="text" value={sampleText1} onChange={(e) => setSampleText1(e.target.value)} className="w-full p-3 border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" /></div><div className="flex items-center"><input id="italic1" type="checkbox" checked={isItalic1} onChange={handleItalic1Toggle} className="h-4 w-4 text-blue-600 border-gray-300 rounded dark:border-gray-600" /><label htmlFor="italic1" className="ml-2 block text-sm text-gray-900 dark:text-gray-300">Italic</label></div></div></fieldset>
          <fieldset className="border rounded-lg p-4 border-gray-300 dark:border-gray-600"><legend className="text-lg font-semibold text-gray-800 px-2 dark:text-gray-100">Font 2</legend><div className="grid grid-cols-1 gap-4"><div><label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Font URL</label><input type="text" value={font2Url} onChange={(e) => setFont2Url(e.target.value)} className="w-full p-3 border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" /></div><div><label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Font Family Name</label><input type="text" value={font2Family} onChange={(e) => setFont2Family(e.target.value)} className="w-full p-3 border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" /></div><div><label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Sample Text 2</label><input type="text" value={sampleText2} onChange={(e) => setSampleText2(e.target.value)} className="w-full p-3 border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" /></div><div className="flex items-center"><input id="italic2" type="checkbox" checked={isItalic2} onChange={handleItalic2Toggle} className="h-4 w-4 text-blue-600 border-gray-300 rounded dark:border-gray-600" /><label htmlFor="italic2" className="ml-2 block text-sm text-gray-900 dark:text-gray-300">Italic</label></div></div></fieldset>
        </div>

        <fieldset className="mt-4 border-b pb-4 border-gray-200 dark:border-gray-700"><legend className="text-lg font-semibold text-gray-800 mb-2 dark:text-gray-100">Shared Display Options</legend><div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center"><div><label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Font Size: {fontSize}px</label><input type="range" min="12" max="100" value={fontSize} onChange={(e) => setFontSize(e.target.value)} className="w-full h-2 bg-gray-300 rounded-lg appearance-none cursor-pointer dark:bg-gray-800" /></div><div><label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Line Height: {lineHeight}</label><input type="range" min="1" max="3" step="0.1" value={lineHeight} onChange={(e) => setLineHeight(e.target.value)} className="w-full h-2 bg-gray-300 rounded-lg appearance-none cursor-pointer dark:bg-gray-800" /></div><div className="flex items-center"><input id="show-background" type="checkbox" checked={showBackground} onChange={(e) => setShowBackground(e.target.checked)} className="h-4 w-4 text-blue-600 border-gray-300 rounded dark:border-gray-600" /><label htmlFor="show-background" className="ml-2 block text-sm text-gray-900 dark:text-gray-300">Show Background</label></div><div className="flex items-center"><input id="show-center-line-comparison" type="checkbox" checked={showCenterLine} onChange={(e) => setShowCenterLine(e.target.checked)} className="h-4 w-4 text-blue-600 border-gray-300 rounded dark:border-gray-600" /><label htmlFor="show-center-line-comparison" className="ml-2 block text-sm text-gray-900 dark:text-gray-300">Show Center Line</label></div></div></fieldset>
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-2 items-center">
          ...
          <button onClick={handleShare} className="w-full bg-green-500 text-white px-6 py-3 rounded-md font-semibold hover:bg-green-600">Share Configuration</button>
        </div>
      </div>
