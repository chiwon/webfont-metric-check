export default function ComparisonPreview({
	...
	return (
		<div className="mt-8 bg-white p-6 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
			...
			<div className="grid grid-cols-1 gap-y-6">
				{weights.map((weight) => (
					<div key={weight}>
						<p className="text-sm font-bold text-gray-600 mb-1 dark:text-gray-300">
							Weight: {weight}
						</p>
						<div
						...
						>
							<div className="whitespace-nowrap pl-2">
								...
								{/* Spacer */}
								{font1 && sampleText1 && font2 && sampleText2 && (
									<span>&nbsp;</span>
								)}
							...
							{/* Center line */}
							{showCenterLine && (
								<div className="absolute top-1/2 left-0 w-full h-px bg-red-500 opacity-75"></div>
							)}
						</div>
					</div>
				))}
